        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="glass-card rounded-2xl p-10">
              <h3 className="text-gold text-sm tracking-[0.2em] uppercase mb-8">Awards & Recognition</h3>
              <div className="grid grid-cols-2 gap-6">
                {awards.map((award, i) => (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-4 rounded-xl bg-obsidian/50 border border-gold/10"
                  >
